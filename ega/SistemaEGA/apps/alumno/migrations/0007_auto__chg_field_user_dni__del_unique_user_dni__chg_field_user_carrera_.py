...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'User', fields ['dni']
        db.delete_unique(u'alumno_user', ['dni'])


        # Changing field 'User.dni'
        db.alter_column(u'alumno_user', 'dni', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.dni'
        db.alter_column(u'alumno_user', 'dni', self.gf('django.db.models.fields.CharField')(default=11, max_length=10, unique=True))
        # Adding unique constraint on 'User', fields ['dni']
        db.create_unique(u'alumno_user', ['dni'])
    ...
    models = {
        u'alumno.user': {
            ...
            'dni': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
