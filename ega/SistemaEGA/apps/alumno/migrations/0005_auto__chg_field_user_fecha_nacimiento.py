...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.fecha_nacimiento'
        db.alter_column(u'alumno_user', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'User.fecha_nacimiento'
        db.alter_column(u'alumno_user', 'fecha_nacimiento', self.gf('django.db.models.fields.DateField')())
